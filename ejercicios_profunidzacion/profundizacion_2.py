...
if temperatura_1 != temperatura_2 and temperatura_1 != temperatura_3 and temperatura_2 != temperatura_3:
  ...
  temperatura_max = print("Las temperaturas deben ser diferentes")   
...
if temperatura_1 != temperatura_2 and temperatura_1 != temperatura_3 and temperatura_2 != temperatura_3:
 ...
 temperatura_min = print("Las temperaturas deben ser diferentes")  


print (f'Temperatura maxima: {temperatura_max}\nTemepratua minima: {temperatura_min}')